...
;Variables
  ...
  !define PRODUCT_NAME "Electrum Litecoin"
  !define PRODUCT_WEB_SITE "https://github.com/spesmilo/electrum"
  !define PRODUCT_PUBLISHER "Litecoin"
...
;Interface Settings
  ...
  !define MUI_ICON "..\..\electrum\gui\icons\electrum-ltc.ico"
...
Section
  ...
  File "..\..\electrum\gui\icons\electrum-ltc.ico"
  ...
  WriteRegStr HKCU "Software\Classes\litecoin" "DefaultIcon" "$\"$INSTDIR\electrum-ltc.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\litecoin\shell\open\command" "" "$\"$INSTDIR\electrum-${PRODUCT_VERSION}.exe$\" $\"%1$\""
  ...
  WriteRegStr HKCU "Software\Classes\lightning" "DefaultIcon" "$\"$INSTDIR\electrum-ltc.ico, 0$\""
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\electrum-ltc.ico"
